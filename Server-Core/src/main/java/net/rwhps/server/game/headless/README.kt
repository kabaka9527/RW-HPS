package net.rwhps.server.game.headless
...
class README {
    private val readme = """
         ...
         *
         * https://github.com/deng-rui/RW-HPS/blob/master/Server-Core/src/main/java/net/rwhps/server/game/simulation/README.kt
         */
